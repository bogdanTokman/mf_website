...
exports.initCommonCtaBlock = exports.initNewsScreenAnimation = exports.initMobileNewsSlider = exports.initWordsAnimation = exports.setParallax = exports.css = exports.Resp = exports.isScrolledIntoView = exports.toggleClass = exports.currentPage = exports.$footer = exports.$header = exports.$window = exports.$document = exports.$body = undefined;
...
var newsScreen = '.news_block';
var newsTween = Resp.isMobile || Resp.isTablet ? new _gsap.TimelineMax() : new _gsap.TimelineMax().set(['' + newsScreen], { opacity: 0 });
 ...
 * @param speedY
 */
var setParallax = exports.setParallax = function setParallax(item, pageX, speedX, pageY, speedY) {
...
var initWordsAnimation = exports.initWordsAnimation = function initWordsAnimation() {
...
var initMobileNewsSlider = exports.initMobileNewsSlider = function initMobileNewsSlider() {
  var slides = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;

  var $toolbar = $('.news');
  var $stepsNav = $('.steps___nav');

  var manager = new Hammer($toolbar[0]);
  var step = 1;
  ...
  manager.on('swipeleft', function (e) {
    ...
    if (index <= slides) {
      ...
      $stepsNav.removeClass(css.active);
...
var initNewsScreenAnimation = exports.initNewsScreenAnimation = function initNewsScreenAnimation() {
  if ($('' + newsScreen).hasClass(css.finished) || newsTween.isActive()) return;

  newsTween.to('' + newsScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(newsScreen + ' h3', .7, { y: -20, opacity: 0 }, {
    y: 0,
    opacity: 1,
    ease: _gsap.Power1.easeOut
  }, .85).fromTo(newsScreen + ' p', .6, { y: -20, opacity: 0 }, {
    y: 0,
    opacity: 1,
    ease: _gsap.Power1.easeOut
  }, 1).staggerFromTo(newsScreen + '  .news_item', .9, { y: -70, opacity: 0 }, {
    y: 0,
    opacity: 1,
    ease: _gsap.Power1.easeOut
  }, 0.2, 1.4).fromTo(newsScreen + ' .btn', .6, { y: -20, opacity: 0 }, {
    y: 0,
    opacity: 1,
    ease: _gsap.Power1.easeOut
  }, 2).addCallback(function () {
    $(newsScreen).addClass(css.finished);
  });
};

var initCommonCtaBlock = exports.initCommonCtaBlock = function initCommonCtaBlock() {
  if (Resp.isTablet || Resp.isMobile) return;
  ...
  $window.on('scroll', function (e) {
    if (isScrolledIntoView($item) && !$item.hasClass(css.finished)) {
      $item.addClass(css.finished);
  ...
  $window.on('mousemove', function (event) {
    var pageX = event.pageX - $window.width() * 0.5;
    var pageY = event.pageY - $window.height() * 0.5;

    $parallaxItems.each(function () {
      var item = $(this);
      setParallax(item, pageX, 50, pageY, 10);
    });
  });
};
...
var Common = exports.Common = function () {
  ...
  _createClass(Common, [{
    ...
    value: function initDropdown() {
      ...
      $('.dropdown > .menu_link').hover(function () {
...
var _Pricing = __webpack_require__(18);

var _Pricing2 = _interopRequireDefault(_Pricing);

var _vintagePopup = __webpack_require__(19);
...
var _Solutions = __webpack_require__(24);
...
var _TweenMaxBase = __webpack_require__(15);
...
var Home = function () {
  ...
  function Home() {
    ...
    if (_helpers.Resp.isMobile) {
      (0, _helpers.initMobileNewsSlider)(2);
      return;
    }
  ...
  _createClass(Home, [{
      ...
      _helpers.$window.on('scroll', function (e) {
        $(_this.section).each(function () {
          ...
          if ((0, _helpers.isScrolledIntoView)($(_this.newsScreen))) {
            (0, _helpers.initNewsScreenAnimation)();
          }
    ...
    value: function initThirdScreenParallax() {
      ...
      $screen.on('mousemove', function (event) {
        ...
        $parallaxItems.each(function () {
          var item = $(this);
          (0, _helpers.setParallax)(item, pageX, 50, pageY, 15);
        });
      });
    }
  }, {
    ...
    value: function initCtaScreen() {
      ...
      this.ctaTween.to('' + this.ctaScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.ctaScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        ...
        $(_this5.ctaScreen).addClass(_helpers.css.finished);
      });
    ...
    value: function initCtaParallax() {
      ...
      $screen.on('mousemove', function (event) {
        ...
        $parallaxItems.each(function () {
          var item = $(this);
          (0, _helpers.setParallax)(item, pageX, 50, pageY, 10);
        });
      });
    }
  }, {
      ...
      $screen.on('mousemove', function (event) {
        ...
        $parallaxItems.each(function () {
          ...
          if (item.hasClass('left__side')) {
            (0, _helpers.setParallax)(item, pageX, 50, pageY, -55);
          } else if (item.hasClass('left__side_1')) {
            (0, _helpers.setParallax)(item, pageX, -65, pageY, 85);
          } else if (item.hasClass('left__side_2')) {
            (0, _helpers.setParallax)(item, pageX, 25, pageY, -25);
          } else if (item.hasClass('ellipse_3')) {
            (0, _helpers.setParallax)(item, pageX, 65, pageY, 85);
          } else if (item.hasClass('ellipse_5')) {
            (0, _helpers.setParallax)(item, pageX, -65, pageY, -35);
          } else if (item.hasClass('ellipse_2')) {
            (0, _helpers.setParallax)(item, pageX, 25, pageY, -35);
          } else if (item.hasClass('chair')) {
            (0, _helpers.setParallax)(item, pageX, -75, pageY, 35);
          } else {
            (0, _helpers.setParallax)(item, pageX, 50, pageY, 75);
          }
        });
      });
    }
...
var News = function () {
  function News() {
    ...
    if (_helpers.Resp.isTablet || _helpers.Resp.isMobile) return;
    this.init();
    this.initFirstScreenParallax();
  }
  ...
  _createClass(News, [{
    ...
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        ...
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, .8).staggerFromTo('.blog_screen .bg > div', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1).staggerFromTo('.blog_screen .bg > svg', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
...
var Solutions = function () {
  function Solutions() {
    ...
    if (_helpers.Resp.isMobile) {
      (0, _helpers.initMobileNewsSlider)();
      (0, _helpers.initWordsAnimation)();
      return;
    }
  ...
  _createClass(Solutions, [{
    ...
    value: function init() {
      this.initFirstScreen();
      this.initScrollAnimationEvents();
      this.initParallax();
      (0, _helpers.initWordsAnimation)();
    }
  }, {
    ...
    key: 'initScrollAnimationEvents',
    value: function initScrollAnimationEvents() {
      var _this = this;
      _helpers.$window.on('scroll', function (e) {
        $(_this.section).each(function () {
          var index = $(_this.section).index(this);
    ...
    value: function initFirstScreen() {
      ...
      this.initSecondScreenScrollAnimationEvents();
    }
  }, {
    key: 'initSecondScreenScrollAnimationEvents',
    value: function initSecondScreenScrollAnimationEvents() {
      var _this = this;
      ...
      _helpers.$window.on('scroll', function (e) {
        ...
        var $newsItem = $('' + _this.newsScreen);
        if ((0, _helpers.isScrolledIntoView)($newsItem) && !$newsItem.hasClass(_helpers.css.finished)) {
          (0, _helpers.initNewsScreenAnimation)();
        }
      });
    }
...
var Services = function () {
  function Services() {
    ...
    this.contetItems = '.sulutions__wrapper  .solutions__item';
  ...
  _createClass(Services, [{
    ...
    value: function initFirstScreen() {
      ...
      this.firstTween.fromTo('header', .7, { y: -120, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.95).fromTo('.solutions__item:eq(0) .sub_title', .7, { y: 20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2).fromTo('.solutions__item:eq(0) .description', .7, { y: 20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo('.solutions__item:eq(0) img', .7, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).addCallback(function () {
        return $(_this2.secondScreen).addClass(_helpers.css.finished);
      });
