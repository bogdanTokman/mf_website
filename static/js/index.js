...
exports.setParallax = exports.css = exports.Resp = exports.isScrolledIntoView = exports.toggleClass = exports.currentPage = exports.$footer = exports.$header = exports.$window = exports.$document = exports.$body = undefined;
...
var Home = function () {
  ...
  _createClass(Home, [{
    ...
    value: function initNewsScreen() {
      ...
      this.newsTween.to('' + this.newsScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.newsScreen + ' h3', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
  ...
  _createClass(Services, [{
    ...
    value: function initFirstScreen() {
      ...
      this.firstTween.fromTo('header', .7, { y: -120, opacity: 0 }, {
        ...
        return $(_this.secondScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initWords',
