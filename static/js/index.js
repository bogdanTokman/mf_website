...
var Ease = _gsScope.Ease,
    ...
    TweenPlugin = _gsScope.TweenPlugin;
exports.Ease = Ease;
...
var _TimelineLite = __webpack_require__(4);
...
var Common = exports.Common = function () {
  ...
  function Common() {
    ...
    this.menuTween = new _gsap.TimelineMax();

    var secondtween = new _gsap.TimelineMax();

    var $items = $('input, textarea');

    $items.focus(function () {
      $(this).parent().addClass(_helpers.css.focus);
      $(this).parent().removeClass(_helpers.css.error);
    });

    $items.blur(function () {
      if ($(this).val().length === 0) $(this).parent().removeClass(_helpers.css.focus);
    });
  ...
  _createClass(Common, [{
    ...
    key: 'setParallax',
    value: function setParallax(item, pageX, speedX, pageY, speedY) {
      _gsap.TweenLite.to(item, 0.5, {
        x: (item.position().left + pageX * speedX) * 0.0008,
        y: (item.position().top + pageY * speedY) * 0.0008,
        ease: _gsap.Linear.ease
      });
    }
  }, {
    key: 'initAnimation',
    ...
    value: function initHeaderAnimation() {
      if (!_helpers.Resp.isMobile) return;
    ...
    value: function initDropdown() {
      $('.block__link:eq(0)').hover(function () {
        _gsap.TweenLite.to($('.inside__menu:eq(0)'), .5, { opacity: 1, zIndex: 2, visibility: 'visible' });
        _gsap.TweenLite.to($('.inside__menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
      }, function () {});

      $('.block__link:eq(1)').hover(function () {
        _gsap.TweenLite.to($('.inside__menu:eq(0)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.inside__menu:eq(1)'), .5, { opacity: 1, zIndex: 2, visibility: 'visible' });
      }, function () {});

      $('.dropdown:eq(0) > .menu_link').hover(function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 1, zIndex: 2, visibility: 'visible' });
        _gsap.TweenLite.to($('.inside__menu:eq(0)'), .5, { opacity: 1, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.inside__menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
      ...
      $('.sub_menu').hover(function () {}, function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.inside__menu:eq(0)'), .5, { opacity: 1, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.inside__menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.lang___item'), .5, { opacity: 0, zIndex: 2, visibility: 'hidden' });
    ...
    value: function initBody() {
      new _gsap.TimelineMax({ delay: 1 }).fromTo(Common.animClass, .5, { opacity: 0 }, { opacity: 1 });
    }
  }, {
    key: 'initMobileMenu',
    value: function initMobileMenu() {
      ...
      $mobileBtn.click(function () {
        ...
        _helpers.$body.toggleClass(_helpers.css.overflow);

        var tween = new _gsap.TimelineMax();

        var $this = $mobileMenu;

        $this.toggleClass(_helpers.css.open);

        $this.parent().toggleClass(_helpers.css.open);

        if ($this.hasClass(_helpers.css.open)) {
          if (_this.menuTween.reversed()) {
            _this.menuTween.play();
            return;
          }

          _this.menuTween.to($mobileMenu, 0.2, { right: 0, ease: _gsap.Power1.easeOut }).staggerFromTo('.mobile__menu  li', 0.2, { x: 35, opacity: 0 }, {
            x: 0, opacity: 1, ease: _gsap.Power1.easeOut
          }, 0.1, 0.2);
        } else {
    ...
    value: function initCommonCtaBlock() {
      ...
      new _gsap.TimelineMax().set(['.cta_block'], { opacity: 0 });

      _helpers.$window.on('scroll', function (e) {
        if ((0, _helpers.isScrolledIntoView)($item) && !$item.hasClass(_helpers.css.finished)) {
          $item.addClass(_helpers.css.finished);
          var timeLine = new _gsap.TimelineMax().to('.cta_block', .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3);
          timeLine.fromTo('.cta_block h2', .7, { y: -20, opacity: 0 }, {
            y: 0,
            opacity: 1,
            ease: _gsap.Power1.easeOut
          }, 1.35).fromTo('.cta_block p', .6, { y: -20, opacity: 0 }, {
            y: 0,
            opacity: 1,
            ease: _gsap.Power1.easeOut
          }, 1.5).fromTo('.cta_block svg', .8, { x: 220, opacity: 0 }, {
            x: 0,
            opacity: 1,
            ease: _gsap.Power1.easeOut
          }, 1.15).staggerFromTo('.cta_block  .row', 0.65, {
            opacity: 0,
            y: -20
          }, {
            opacity: 1,
            y: 0,
            ease: _gsap.Power1.easeOut
          }, 0.2, 1.8).fromTo('.cta_block .line_arrows', .6, { y: -20, opacity: 0 }, {
            y: 0,
            opacity: 1,
            ease: _gsap.Power1.easeOut
          }, .7).fromTo('.cta_block .btn', .5, { y: 60, opacity: 0 }, {
            y: 0,
            opacity: 1,
            ease: _gsap.Power1.easeOut
          }, 1.2);
          ...
          new _gsap.TimelineMax({
            repeat: -1
          }).staggerFromTo('.cta_block .nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, {
            opacity: 1,
            ease: _gsap.Power1.easeOut
          }, 0.2);
        }
      ...
      var $parallaxItems = $('.cta_block > .bg');

      _helpers.$window.on('mousemove', function (event) {
        var pageX = event.pageX - _helpers.$window.width() * 0.5;
        var pageY = event.pageY - _helpers.$window.height() * 0.5;
...
(function(name) {
  ...
  if (typeof(module) !== "undefined" && module.exports) { //node
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(15)], __WEBPACK_AMD_DEFINE_FACTORY__ = (getGlobal),
...
var _vintagePopup = __webpack_require__(29);
...
var _Solutions = __webpack_require__(34);
...
window.Popup = _vintagePopup2.default;
_vintagePopup2.default.expose($);
$('[data-popup-target]').popup();
_Common2.default.initBody();
...
switch (_helpers.currentPage) {
  ...
  case 'about':
    ...
    break;
  case 'pricing':
    new _Pricing2.default();
    _Common2.default.initBody();
    break;
  case 'blog':
    new _News2.default();
    _Common2.default.initBody();
    _Common2.default.initCommonCtaBlock();
    break;
  case 'article':
    new _Article2.default();
    _Common2.default.initBody();
    _Common2.default.initCommonCtaBlock();
    break;
  case 'solutions':
    new _Solutions2.default();
    _Common2.default.initBody();
    _Common2.default.initCommonCtaBlock();
    break;
  case 'services':
    new _Services2.default();
    _Common2.default.initCommonCtaBlock();
    _Common2.default.initBody();
    break;
...
var _TweenMaxBase = __webpack_require__(18);
...
var Home = function () {
  ...
  function Home() {
    ...
    this.sliderTween = new _gsap.TimelineMax().set(['' + this.sliderScreen], { opacity: 0 });

    this.newsScreen = '.news_block';
    this.newsTween = new _gsap.TimelineMax().set(['' + this.newsScreen], { opacity: 0 });

    this.ctaScreen = '.cta_block_';
    this.ctaTween = new _gsap.TimelineMax().set(['' + this.ctaScreen], { opacity: 0 });
  ...
  _createClass(Home, [{
    ...
    value: function init() {
      ...
      _helpers.$window.on('scroll', function (e) {
        $(_this.section).each(function () {
          var index = $(_this.section).index(this);

          if ((0, _helpers.isScrolledIntoView)($(_this.secondScreen))) {
            var _index = $(_this.section).index(this);
            if ((0, _helpers.isScrolledIntoView)($(this)) && _index === 1) {
              _this.initSecondScreen();
            }
          }
          if ((0, _helpers.isScrolledIntoView)($(_this.thirdScreen), -50)) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 2) {
              _this.initThirdScreen();
            }
          }
          if ((0, _helpers.isScrolledIntoView)($(_this.newsScreen))) {
            _this.initNewsScreen();
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.ctaScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this))) {
              _this.initCtaScreen();
            }
          }
        });
    ...
    key: 'initFirstScreen',
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -120, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1).fromTo(this.firstScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.75).fromTo(this.firstScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2).fromTo(this.firstScreen + ' .first__bg', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.5).fromTo(this.firstScreen + ' .left__side', 2, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 3).fromTo(this.firstScreen + ' .left__side_1', 2.3, { y: -30, x: -50, opacity: 0 }, {
        y: 0,
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 3.2).fromTo(this.firstScreen + ' .left__side_2', 2, { y: -30, x: 50, opacity: 0 }, {
        y: 0,
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 3.3).fromTo(this.firstScreen + ' .second__bg', .8, { x: -220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.35).fromTo(this.firstScreen + ' .ellipse_1', 1.5, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo(this.firstScreen + ' .ellipse_2', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.8).fromTo(this.firstScreen + ' .ellipse_3', 1.5, { x: -45, y: 50, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo(this.firstScreen + ' .ellipse_5', 1.5, { x: -45, y: 50, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo(this.firstScreen + ' .ellipse_7', 1.5, { x: -45, y: 50, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo(this.firstScreen + ' .ellipse_6', 1.5, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo(this.firstScreen + ' .ellipse_4', 2.3, { x: 85, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2).fromTo(this.firstScreen + ' .row', .9, { y: 30, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power4.easeOut
      }, 1.6).fromTo(this.firstScreen + ' .btn', .9, { y: 50, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.7);
    ...
    key: 'initSecondScreen',
    value: function initSecondScreen() {
      var _this2 = this;
      ...
      this.secondTween.to('' + this.secondScreen, .8, { opacity: 1, ease: _gsap.Power1.easeOut }, .5).fromTo(this.secondScreen + ' h3', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.4).staggerFromTo(this.contetItems, 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.8).addCallback(function () {
        return $(_this2.secondScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initThirdScreen',
    value: function initThirdScreen() {
      var _this3 = this;

      if ($('' + this.thirdScreen).hasClass(_helpers.css.finished) || this.thirdTween.isActive()) return;

      this.initThirdScreenParallax();

      this.thirdTween.to('' + this.thirdScreen, .8, { opacity: 1, ease: _gsap.Power1.easeOut }, .5).fromTo(this.thirdScreen + ' h4', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.4).addCallback(function () {
        $(_this3.thirdScreen).addClass(_helpers.css.finished);
      });

      var _this = this;
      _helpers.$window.on('scroll', function (e) {
        $(_this.thirdScreenContentItmes).each(function () {
          var index = $(_this.thirdScreenContentItmes).index(this);
          var selector = '.products__list > .product__item:eq(' + index + ')';
          var $item = $(selector);
          if ((0, _helpers.isScrolledIntoView)($item) && !$item.hasClass(_helpers.css.active)) {
            ...
            timeLine.fromTo(selector + '.' + _helpers.css.active + '  .sub__info', .7, { y: -30, opacity: 0 }, {
              ...
              opacity: 1,
              ease: _gsap.Power1.easeOut
            }, .55).fromTo(selector + '.' + _helpers.css.active + '  .sub_title', .7, { y: -20, opacity: 0 }, {
              y: 0,
              opacity: 1,
              ease: _gsap.Power1.easeOut
            }, .75).fromTo(selector + '.' + _helpers.css.active + '  .sub__descr', .6, { y: -20, opacity: 0 }, {
              y: 0,
              opacity: 1,
              ease: _gsap.Power1.easeOut
            }, 1).fromTo(selector + '.' + _helpers.css.active + '  .btn', .6, { y: -20, opacity: 0 }, {
              y: 0,
              opacity: 1,
              ease: _gsap.Power1.easeOut
            }, .9);
            ...
            if ($item.hasClass('reverse')) {
              timeLine.fromTo(selector + '.' + _helpers.css.active + '  .left_side > img', .6, { x: -120, opacity: 0 }, {
                x: 0,
                opacity: 1,
                ease: _gsap.Power1.easeOut
              }, .9);
            } else {
              timeLine.fromTo(selector + '.' + _helpers.css.active + '  .right_side > img', .6, { x: 120, opacity: 0 }, {
                x: 0,
                opacity: 1,
                ease: _gsap.Power1.easeOut
              }, .9);
    ...
    key: 'initThirdScreenParallax',
    value: function initThirdScreenParallax() {
      var $screen = $(this.thirdScreen);
      var $parallaxItems = $screen.find('.parallax');
      var _this = this;

      $screen.on('mousemove', function (event) {
        var pageX = event.pageX - $screen.width() * 0.5;
        var pageY = event.pageY - $screen.height() * 0.5;
    ...
    key: 'initSliderScreen',
    value: function initSliderScreen() {
      var _this4 = this;

      if ($('' + this.sliderScreen).hasClass(_helpers.css.finished) || this.sliderTween.isActive()) return;

      this.sliderTween.to('' + this.sliderScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.sliderScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .3).fromTo($(this.sliderScreen + ' .slide:eq(0)'), .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .55).staggerFromTo(this.sliderScreen + ' .slide  div', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1).addCallback(function () {
        $(_this4.sliderScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initNewsScreen',
    value: function initNewsScreen() {
      var _this5 = this;

      if ($('' + this.newsScreen).hasClass(_helpers.css.finished) || this.newsTween.isActive()) return;

      this.newsTween.to('' + this.newsScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.newsScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).fromTo(this.newsScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1).staggerFromTo(this.newsScreen + '  .news_item', .9, { y: -70, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.4).fromTo(this.newsScreen + ' .btn', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2).addCallback(function () {
        $(_this5.newsScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initCtaScreen',
    value: function initCtaScreen() {
      var _this6 = this;

      if ($('' + this.ctaScreen).hasClass(_helpers.css.finished) || this.ctaTween.isActive()) return;

      this.initCtaParallax();

      this.ctaTween.to('' + this.ctaScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.ctaScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).fromTo(this.ctaScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.2).fromTo(this.ctaScreen + ' .row', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.4).fromTo(this.ctaScreen + ' .line_arrows', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.ctaScreen + ' .btn', .5, { y: 60, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.2).fromTo(this.ctaScreen + ' .cta', .9, { y: 120, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).addCallback(function () {
        $(_this6.ctaScreen).addClass(_helpers.css.finished);
      });

      new _gsap.TimelineMax({ delay: .9, repeat: -1 }).staggerFromTo(this.ctaScreen + ' .items', .75, { y: 20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8).addCallback(function () {
        $(_this6.ctaScreen).addClass(_helpers.css.finished);
      });

      new _gsap.TimelineMax({
        repeat: -1
      }).staggerFromTo(this.ctaScreen + ' .nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2);
    }
    ...
    key: 'initCtaParallax',
    value: function initCtaParallax() {
      var $screen = $(this.ctaScreen);
      var $parallaxItems = $screen.find('.parallax');
      var _this = this;
    ...
    key: 'initFirstScreenParallax',
    value: function initFirstScreenParallax() {
      ...
      $screen.on('mousemove', function (event) {
        ...
        $parallaxItems.each(function () {
          ...
          if (item.hasClass('left__side')) {
            _thus.setParallax(item, pageX, 50, pageY, -55);
          } else if (item.hasClass('left__side_1')) {
            _thus.setParallax(item, pageX, -65, pageY, 85);
          } else if (item.hasClass('left__side_2')) {
            _thus.setParallax(item, pageX, 25, pageY, -25);
          } else if (item.hasClass('ellipse_3')) {
            _thus.setParallax(item, pageX, 65, pageY, 85);
          } else if (item.hasClass('ellipse_5')) {
            _thus.setParallax(item, pageX, -65, pageY, -35);
          } else if (item.hasClass('ellipse_2')) {
            _thus.setParallax(item, pageX, 25, pageY, -35);
          } else if (item.hasClass('chair')) {
            _thus.setParallax(item, pageX, -75, pageY, 35);
          } else {
...
var Products = function () {
  function Products() {
    ...
    this.secondTween = new _gsap.TimelineMax();
    this.secondScreen = '.campaigns';

    this.featuresScreen = '.features';
    this.featuresTween = new _gsap.TimelineMax().set(['' + this.featuresScreen], { opacity: 0 });
    this.featuresScreen = '.features';

    this.webPushScreen = '.web_push';
    this.webPushTween = new _gsap.TimelineMax().set([$(this.webPushScreen + ' circle')], { fill: '#A9ADC6' });

    this.webPushTween.set(['' + this.webPushScreen], { opacity: 0 });

    this.webPushTween.set([$(this.webPushScreen + ' circle:eq(1)')], { fill: '#273271' });

    this.pushFeaturesScreen = '.push_features';
    this.pushFeaturesTween = new _gsap.TimelineMax().set(['' + this.pushFeaturesScreen], { opacity: 0 });

    this.appPushScreen = '.app_push';
    this.appPushTween = new _gsap.TimelineMax().set([$(this.appPushScreen + ' circle')], { fill: '#A9ADC6' });

    this.appPushTween.set(['' + this.appPushScreen], { opacity: 0 });

    this.appPushTween.set([$(this.appPushScreen + ' circle:eq(2)')], { fill: '#273271' });

    this.appScreen = '.app';
    this.appTween = new _gsap.TimelineMax().set([$(this.appScreen + ' circle')], { fill: '#A9ADC6' });

    this.appTween.set([$(this.appScreen + ' circle:eq(3)')], { fill: '#273271' });

    this.appTween.set(['' + this.appScreen], { opacity: 0 });

    this.appPushTween.set([this.apiScreen + ' h2', this.apiScreen + ' .item'], { opacity: 0 });

    this.appFeaturesSreen = '.app_features';
    this.appFeaturesTween = new _gsap.TimelineMax().set(['' + this.appFeaturesSreen], { opacity: 0 });

    this.apiScreen = '.api';
    this.apiTween = new _gsap.TimelineMax().set(['' + this.apiScreen], { opacity: 0 });
  ...
  _createClass(Products, [{
    ...
    value: function init() {
      ...
      _helpers.$window.on('scroll', function (e) {
        $(_this.section).each(function () {
          ...
          if ((0, _helpers.isScrolledIntoView)($(_this.secondScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 1) {
              _this.initSecondScreen();
            }
          }
          if ((0, _helpers.isScrolledIntoView)($(_this.featuresScreen))) {
            _this.initFeatures();
          }
          if ((0, _helpers.isScrolledIntoView)($(_this.webPushScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 2) {
              _this.initWebPushScreen();
            }
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.pushFeaturesScreen)) && index === 3) {
            _this.initPushFeatures();
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.appPushScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 4) {
              _this.initAppPushScreen();
            }
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.appScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 5) {
              _this.initAppScreen();
            }
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.appFeaturesSreen))) {
            _this.initAppFeatures();
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.apiScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 6) {
              _this.initApiScreen();
            }
          }
        });
    ...
    key: 'initFirstScreen',
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo(this.firstScreen + ' .left', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo(this.firstScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo(this.firstScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' svg', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo(this.firstScreen + ' .first_item', 2, { y: -75, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .second_item', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8);
    ...
    value: function initSecondScreen() {
      ...
      this.secondTween.fromTo(this.secondScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).staggerFromTo(this.secondScreen + ' .sub_info div', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.3).fromTo(this.secondScreen + ' svg', .8, { x: -220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).staggerFromTo(this.secondScreen + ' .nav_item', 0.95, {
        opacity: 0,
        width: 0
      }, {
        opacity: 1,
        width: 320,
        ease: _gsap.Power1.easeOut
      }, 0.5, 1.3).staggerFromTo(this.secondScreen + ' circle', 0.65, {
        opacity: 0,
        attr: {
          r: 0
        }
    ...
    value: function initFeatures() {
      ...
      if ($('' + this.featuresScreen).hasClass(_helpers.css.finished) || this.featuresTween.isActive()) return;

      this.featuresTween.to('' + this.featuresScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).staggerFromTo(this.featuresScreen + '  .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, .8).addCallback(function () {
        return $(_this3.featuresScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initWebPushScreen',
    value: function initWebPushScreen() {
      var _this4 = this;

      if ($('' + this.webPushScreen).hasClass(_helpers.css.finished) || this.webPushTween.isActive()) return;

      this.webPushTween.to('' + this.webPushScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.webPushScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .65).staggerFromTo(this.webPushScreen + ' .info_block div', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.1).fromTo(this.webPushScreen + ' svg:eq(1)', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).staggerFromTo(this.webPushScreen + ' .nav_item', 0.95, {
        opacity: 0,
        width: 0
      }, {
        opacity: 1,
        width: 320,
        ease: _gsap.Power1.easeOut
      }, 0.5, 1.1).staggerFromTo(this.webPushScreen + ' circle', 0.65, {
        opacity: 0,
        attr: {
          r: 0
        }
        ...
        return $(_this4.webPushScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initPushFeatures',
    value: function initPushFeatures() {
      var _this5 = this;

      if ($('' + this.pushFeaturesScreen).hasClass(_helpers.css.finished) || this.pushFeaturesTween.isActive()) return;

      this.pushFeaturesTween.to('' + this.pushFeaturesScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).staggerFromTo(this.pushFeaturesScreen + '  .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        ...
        return $(_this5.pushFeaturesScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initAppPushScreen',
    value: function initAppPushScreen() {
      var _this6 = this;

      if ($('' + this.appPushScreen).hasClass(_helpers.css.finished) || this.appPushTween.isActive()) return;

      this.appPushTween.to('' + this.appPushScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.appPushScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .55).fromTo(this.appPushScreen + ' p', .75, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .65).staggerFromTo(this.appPushScreen + '  .info_block div', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, .2).fromTo(this.appPushScreen + ' .bg', .8, { x: -220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).staggerFromTo(this.appPushScreen + ' .nav_item', 0.95, {
        opacity: 0,
        width: 0
      }, {
        opacity: 1,
        width: 320,
        ease: _gsap.Power1.easeOut
      }, 0.5, 1).staggerFromTo(this.appPushScreen + ' circle', 0.65, {
        opacity: 0,
        attr: {
          r: 0
        }
        ...
        ease: _gsap.Power1.easeOut
      }, 0.5, 1).addCallback(function () {
        return $(_this6.appPushScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initAppScreen',
    value: function initAppScreen() {
      var _this7 = this;

      if ($('' + this.appScreen).hasClass(_helpers.css.finished) || this.appTween.isActive()) return;

      this.appTween.to('' + this.appScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.appScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .65).fromTo(this.appScreen + ' p', .75, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .75).fromTo(this.appScreen + ' .bg', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).staggerFromTo(this.appScreen + ' .nav_item', 0.95, {
        opacity: 0,
        width: 0
      }, {
        opacity: 1,
        width: 320,
        ease: _gsap.Power1.easeOut
      }, 0.5, 1).staggerFromTo(this.appScreen + ' circle', 0.65, {
        opacity: 0,
        attr: {
          r: 0
        }
        ...
        return $(_this7.appScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initAppFeatures',
    value: function initAppFeatures() {
      var _this8 = this;

      if ($('' + this.appFeaturesSreen).hasClass(_helpers.css.finished) || this.appFeaturesTween.isActive()) return;

      this.appFeaturesTween.to('' + this.appFeaturesSreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).staggerFromTo(this.appFeaturesSreen + '  .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        ...
        return $(_this8.appFeaturesSreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initApiScreen',
    value: function initApiScreen() {
      var _this9 = this;

      if ($('' + this.apiScreen).hasClass(_helpers.css.finished) || this.apiTween.isActive()) return;

      this.apiTween.to('' + this.apiScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.apiScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).staggerFromTo(this.apiScreen + '  .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        ...
        return $(_this9.apiScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'setParallax',
...
var Features = function () {
  function Features() {
    ...
    this.secondTween = new _gsap.TimelineMax({ delay: 1.2 }).set(['' + this.secondScreen], { opacity: 0 });

    this.featuresItems = '.features_items';
    this.featuresTween = new _gsap.TimelineMax({ delay: .9 }).set(['' + this.featuresItems], { opacity: 0 });

    this.deliverabilityScreen = '.deliverability';
    this.deliverabilityTween = new _gsap.TimelineMax({ delay: .9 }).set(['' + this.deliverabilityScreen], { opacity: 0 });

    this.splitsScreen = '.splits';
    this.splitsTween = new _gsap.TimelineMax({ delay: .9 }).set(['' + this.splitsScreen], { opacity: 0 });

    this.stepsScreen = '.steps';
    this.stepsTween = new _gsap.TimelineMax({ delay: .9 }).set(['' + this.stepsScreen], { opacity: 0 });
  ...
  _createClass(Features, [{
    ...
    value: function init() {
      ...
      _helpers.$window.on('scroll', function (e) {
        $(_this.section).each(function () {
          ...
          if ((0, _helpers.isScrolledIntoView)($(_this.featuresItems))) {
            _this.initFeaturesItems();
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.deliverabilityScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 2) {
              _this.initDeliverabilityScreen();
            }
          }
          if ((0, _helpers.isScrolledIntoView)($(_this.splitsScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 3) {
              _this.initSplitsScreen();
            }
          }

          if ((0, _helpers.isScrolledIntoView)($(_this.stepsScreen))) {
            if ((0, _helpers.isScrolledIntoView)($(this)) && index === 4) {
    ...
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .bg', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo(this.firstScreen + ' .first_circle', 2, { y: -25, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .second_circle', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8);
    ...
    value: function initSecondScreen() {
      ...
      this.secondTween.to('' + this.secondScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.secondScreen + ' .info_block', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).addCallback(function () {
        return $(_this2.secondScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initFeaturesItems',
    value: function initFeaturesItems() {
      var _this3 = this;

      if ($('' + this.featuresItems).hasClass(_helpers.css.finished) || this.featuresTween.isActive()) return;

      this.featuresTween.to('' + this.featuresItems, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).staggerFromTo(this.featuresItems + ' >  .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.3).addCallback(function () {
        return $(_this3.featuresItems).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initDeliverabilityScreen',
    value: function initDeliverabilityScreen() {
      var _this4 = this;

      if ($('' + this.deliverabilityScreen).hasClass(_helpers.css.finished) || this.deliverabilityTween.isActive()) return;

      this.deliverabilityTween.to('' + this.deliverabilityScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.deliverabilityScreen + ' .info_block', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).staggerFromTo(this.deliverabilityScreen + ' > .delivery_items  > .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        ...
        return $(_this4.deliverabilityScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initSplitsScreen',
    value: function initSplitsScreen() {
      var _this5 = this;

      if ($('' + this.splitsScreen).hasClass(_helpers.css.finished) || this.splitsTween.isActive()) return;

      this.splitsTween.to('' + this.splitsScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.splitsScreen + ' .info_block', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).staggerFromTo(this.splitsScreen + ' > .split_items  > .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        ...
        return $(_this5.splitsScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initStepsScreen',
    value: function initStepsScreen() {
      var _this6 = this;

      if ($('' + this.stepsScreen).hasClass(_helpers.css.finished) || this.stepsTween.isActive()) return;

      this.stepsTween.to('' + this.stepsScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.stepsScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo(this.stepsScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.stepsScreen + ' .line_arrows', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.stepsScreen + ' .btn', .9, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.stepsScreen + ' .bg', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).staggerFromTo(this.stepsScreen + ' > .steps_items  > .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.3).fromTo(this.stepsScreen + ' .additional', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.9).fromTo(this.stepsScreen + ' .first_circle', 2, { y: -75, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.stepsScreen + ' .second_circle', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8).fromTo(this.stepsScreen + ' .third_circle', 2, { x: -45, y: -10, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1).fromTo(this.stepsScreen + ' .fourth_circle', 2, { y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.stepsScreen + ' .five_circle', 2, { x: 50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.stepsScreen + ' .six_circle', 2, { x: -50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      ...
      new _gsap.TimelineMax({
        repeat: -1
      }).staggerFromTo(this.stepsScreen + ' .nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2).addCallback(function () {
        return $(_this6.stepsScreen).addClass(_helpers.css.finished);
      });
    ...
    key: 'initStepsParallax',
    value: function initStepsParallax() {
      var $screen = $(this.stepsScreen);
      var $parallaxItems = $screen.find('.parallax');
      var _this = this;
    ...
    key: 'initStepsSlider',
    value: function initStepsSlider() {
      this.sliderTween = new _gsap.TimelineMax();
      this.$toolbar = $('.mobile_steps');

      var $stepsNav = $('.stesp__nav');

      var manager = new Hammer(this.$toolbar[0]);
      var step = 1;
      manager.get('swipe').set({ direction: Hammer.DIRECTION_HORIZONTAL, threshold: 30 });
      manager.on('swipeleft', function (e) {
        e.preventDefault();
        var index = $('.steps___nav.active').index();
        ...
        if (index <= 4) {
          ...
          $('.steps___nav').removeClass(_helpers.css.active);

          console.log(index);

          $('.steps___nav:eq(' + (index + 1) + ')').addClass(_helpers.css.active);
        }
      });
...
var About = function () {
  function About() {
    ...
    this.secondTween = new _gsap.TimelineMax({ delay: .9 });
  ...
  _createClass(About, [{
    ...
    value: function initSecondScreen() {
      ...
      this.secondTween.to('' + this.secondScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.secondScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo(this.secondScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.secondScreen + ' .row', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.4).fromTo(this.secondScreen + ' .line_arrows', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.secondScreen + ' .btn', .9, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.secondScreen + ' .bg', .8, { x: -220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).addCallback(function () {
        $(_this2.secondScreen).addClass(_helpers.css.finished);
      });

      new _gsap.TimelineMax({
        repeat: -1
      }).staggerFromTo(this.secondScreen + ' .nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2);

      var $screen = $(this.secondScreen);
      var $parallaxItems = $screen.find('.parallax');
      var _this = this;
  ...
  function Pricing() {
    ...
    if (_helpers.Resp.isMobile || _helpers.Resp.isTablet) {
      ...
      this.$arrow.click(function () {
        ...
        if ($parent.hasClass(_helpers.css.active)) {
        ...
        if ($parent.hasClass(_helpers.css.active)) {
          setTimeout(function () {
            $parent.toggleClass(_helpers.css.active);
          }, 500);
        } else {
          $parent.toggleClass(_helpers.css.active);
        }
    ...
    this.pricingTween = new _gsap.TimelineMax({ delay: .9 });

    this.ctaScreen = '.cta_block';
    this.ctaTween = new _gsap.TimelineMax({ delay: .9 }).set(['' + this.ctaScreen], { opacity: 0 });
  ...
  _createClass(Pricing, [{
    ...
    value: function initPriceForm() {
      $('.price__popup .btn').click(function (e) {
        ...
        var type = $(this).parent().find('.package_type').val();

        if (name.length <= 2) {
          $(this).parent().find('.name').parent().addClass(_helpers.css.error);
          return false;
        }

        if (company.length <= 2) {
          $$(this).parent().find('.company').parent().addClass(_helpers.css.error);
          return false;
        }

        if (!_Common.Common.validateEmail(email)) {
          $(this).parent().find('.email').parent().addClass(_helpers.css.error);
          return false;
        }

        $.post('https://new.mailfire.io/index.php', {
          email: email,
          name: name,
          company: company,
          package: type,
    ...
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo(this.firstScreen + ' .title', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo(this.firstScreen + ' .subtitle', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .bg', .8, { x: 220, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .img', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5);
    ...
    key: 'initPricingTween',
    value: function initPricingTween() {
      var _this2 = this;

      if ($('' + this.pricingContent).hasClass(_helpers.css.finished) || this.pricingTween.isActive()) return;

      this.pricingTween.fromTo(this.pricingContent + ' .title', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo(this.pricingContent + ' .subtitle', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).addCallback(function () {
        return $(_this2.pricingContent).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initCtaScreen',
    value: function initCtaScreen() {
      ...
      this.ctaTween.to('' + this.ctaScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.ctaScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo(this.ctaScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.ctaScreen + ' .row', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.4).fromTo(this.ctaScreen + ' .line_arrows', .6, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.ctaScreen + ' .btn', .9, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.ctaScreen + ' .bg', .8, { x: 220, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).addCallback(function () {
        return $(_this3.ctaScreen).addClass(_helpers.css.finished);
      });
...
!function () {
  function t(p, i) {
    return void 0 === this || Object.getPrototypeOf(this) !== t.prototype ? new t(p, i) : (e = $(window), o = $(document), n = $("body"), s = $("html, body"), this.options = i = $.extend(!0, { openedClass: "opened", openedBodyClass: "popup-opened", closeBtnSelector: ".popup__close", targetPopupId: p.data("popup-target"), eventsNameSpace: "popup", lockScreen: !0, lockScreenEl: document.body, preventDefault: !1, closeOnBgClick: !0, closeOnEsc: !0, closeOnResize: !1, openOnClick: !0, beforeOpen: null, afterOpen: null, beforeClose: null, afterClose: null, remote: { url: p.data("popup-remote") } }, i), this.$button = p, this.$popup = $('[data-popup-id="' + i.targetPopupId + '"]'), this.defaultEvents = "click." + i.eventsNameSpace + " tap." + i.eventsNameSpace, this._activate(), this);
      ...
      i = !1,
      l = !1;t._getScrollbarWidth = function () {
    if (o.height() <= e.height()) return 0;var t,
        n,
        s = document.createElement("div"),
        p = document.createElement("div");return s.style.visibility = "hidden", s.style.width = "100px", document.body.appendChild(s), t = s.offsetWidth, s.style.overflow = "scroll", p.style.width = "100%", s.appendChild(p), n = p.offsetWidth, s.parentNode.removeChild(s), t - n;
  }, t._lockScreen = function (e) {
    if (!p) {
      var o = $(e),
          n = parseInt(o.css("padding-right"), 10) + t._getScrollbarWidth();o.css("padding-right", n + "px");
    }
    ...
    var t = n.find("[data-popup-id]"),
        e = t.filter("." + this.options.openedClass);if (e.length) {
      var o = e.data("popup");this.prevPopupScrollTop = o.scrollTop, o.close(!0);
    }return this;
    ...
    if (t.replaces instanceof Array) for (var e = 0, o = t.replaces.length; e < o; e++) {
      $(t.replaces[e].what).replaceWith(t.replaces[e].data);
    }if (t.append instanceof Array) for (e = 0, o = t.append.length; e < o; e++) {
      $(t.append[e].what).append(t.append[e].data);
    }if (t.content instanceof Array) for (e = 0, o = t.content.length; e < o; e++) {
      $(t.content[e].what).html(t.content[e].data);
    ...
    var t = this;return this.$button.unbind(this.defaultEvents).on(this.defaultEvents, function (e) {
      if (t.options.preventDefault && e.preventDefault(), t._checkAndCloseAllPopups(), t.options.remote.url) {
        var o = t.options.remote;return $.ajax({ url: o.url, method: "get", cache: "false", dataType: "json", data: o.data, beforeSend: o.onBeforeSend, success: function success(e) {
            t.open(e);
          }, complete: o.onComplete, error: o.onError }), this;
      }t.open(!1);
    }), this;
  }, t.prototype._registerCloseOnResize = function () {
    var o = this,
        s = "resize." + this.options.eventsNameSpace;return i || (e.on(s, function () {
      n.hasClass(o.options.openedBodyClass) && t.closeAllPopups(o.options.openedClass);
    }), i = !0), this;
  }, t.prototype._registerCloseOnEsc = function () {
    var e = this,
        s = "keyup." + this.options.eventsNameSpace;return l || (o.on(s, function (o) {
    ...
    var t = this;return t.$popup.on(this.defaultEvents, function (e) {
      e.target === t.$popup.get(0) && t.close();
    }), this;
  }, t.prototype._registerCloseBtnClick = function () {
    var t = this,
        e = t.$popup.find(this.options.closeBtnSelector);return e && e.unbind && e.on ? (e.unbind(this.defaultEvents).on(this.defaultEvents, function () {
      t.close();
    ...
    return this._checkAndRunCallback(this.options.beforeClose), e || (this.options.lockScreen && t._unlockScreen(this.options.lockScreenEl), n.css({ top: "" }).removeClass(this.options.openedBodyClass), s.scrollTop(this.$popup.data("popupScrollTop")), this.prevScrollTop && (this.prevScrollTop = !1)), this.$popup.removeClass(this.options.openedClass), this._checkAndRunCallback(this.options.afterClose), this;
  }, t.prototype.kill = function () {
    this.$button.unbind(this.defaultEvents), this.$popup.data("popup", null);
  }, t.VERSION = "0.1.75", t.kill = function (t) {
    $(t).data("popup").kill();
  }, t.closeAllPopups = function (t) {
    t = t || "opened";var e = n.find("[data-popup-id]"),
        o = e.filter("." + t);if (o.length) {
      var s = o.data("popup");s.close.call(s, !1);
    }
  };var r = t.expose = function (e) {
    $ = e, $.fn.popup = function (e) {
      var o = [];return this.each(function () {
        var n = $(this);o.push(new t(n, e));
      }), 1 === o.length ? o[0] : o;
    };
  };"object" == ( false ? "undefined" : _typeof(module)) && "object" == _typeof(module.exports) ? module.exports = t :  true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return t;
  }).call(exports, __webpack_require__, exports, module),
  ...
  _createClass(News, [{
    ...
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo('.breadcrumbs', .7, { x: -120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo('.title', .7, { x: -120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).staggerFromTo('.categories > .item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, .8).staggerFromTo('.bg > div', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1).staggerFromTo('.bg > svg', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.2).staggerFromTo('.news_item', 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.4).fromTo('.line__item > .btn', .7, { y: -50, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.5);
    ...
    value: function initFirstScreenParallax() {
      ...
      _helpers.$window.on('mousemove', function (event) {
        ...
        $parallaxItems.each(function () {
          ...
          if (item.hasClass('news__icon')) {
            _this.setParallax(item, pageX, 50, pageY, -55);
          } else if (item.hasClass('heart__icon')) {
            _this.setParallax(item, pageX, -65, pageY, 85);
          } else {
            _this.setParallax(item, pageX, 50, pageY, 75);
          }
    ...
    key: 'initMoreNews',
    value: function initMoreNews() {
      var $button = $('.load__more');

      $button.click(function () {
        var $categoryInput = $('.selected__category');
        var category = null;
        ...
        $.get('/get-more-news?offset=' + offset + '&category=' + category, function (response) {
          var items = JSON.parse(response).replace;
          var $items = $(items);
  ...
  _createClass(Article, [{
    ...
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo('.breadcrumbs', .5, { x: -120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .15).fromTo('.head_content > h1', .8, { x: -120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo('.head_content > img', 1, { x: 120, y: -100, opacity: 0 }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .45).fromTo('.article__date', .8, { x: -120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35).fromTo('#social_side_links', .8, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .35);
    ...
    value: function initNewsFixed() {
      ...
      $(window).scroll(function () {
        ...
        if ($(window).scrollTop() > offset) {
          $('.article__date').css('position', 'absolute').css('top', offset + 'px');
          $('#social_side_links').css('position', 'absolute').css('top', offset + 'px');
        }
      });
    }
  }]);
...
var Solutions = function () {
  function Solutions() {
    ...
    this.secondScreen = '.key_features';
    this.secondTween = new _gsap.TimelineMax().set(['' + this.secondScreen], { opacity: 0 });

    this.contetItems = '.key_features  .features_item';
  ...
  _createClass(Solutions, [{
    ...
    value: function initFirstScreen() {
      ...
      this.firstTween.fromTo('header', .7, { y: -120, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.5).fromTo(this.firstScreen + ' h3', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.95).fromTo(this.firstScreen + ' .solutions__item:eq(0) .sub_title', .7, { y: 20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2).fromTo(this.firstScreen + ' .solutions__item:eq(0) .description', .7, { y: 20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1).fromTo(this.firstScreen + ' .solutions__item:eq(0) img', .7, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 2.1);
      ...
      _helpers.$window.on('scroll', function (e) {
        $('.solutions__item').each(function () {
          var index = $('.solutions__item').index(this);
          if (index === 0) return;

          var selector = '.solutions__item:eq(' + index + ')';
          var $item = $(selector);
          if ((0, _helpers.isScrolledIntoView)($item) && !$item.hasClass(_helpers.css.finished)) {
            $item.addClass(_helpers.css.finished);
            var timeLine = new _gsap.TimelineMax();
            timeLine.fromTo(selector + ' .sub_title', .7, { y: 20, opacity: 0 }, {
              y: 0,
              opacity: 1,
              ease: _gsap.Power1.easeOut
            }, .5).fromTo(selector + ' .description', .7, { y: 20, opacity: 0 }, {
              y: 0,
              opacity: 1,
              ease: _gsap.Power1.easeOut
            }, .7);
            ...
            if ($item.hasClass('reverse')) {
              timeLine.fromTo(selector + ' img', .7, { x: -120, opacity: 0 }, {
                x: 0,
                opacity: 1,
                ease: _gsap.Power1.easeOut
              }, .9);
    ...
    value: function initWords() {
      var $headTitle = $('.head__title');
      var sliderSpan = $headTitle.find('p:eq(1)');

      var $childrens = sliderSpan.children();

      $childrens.each(function (index) {
        var $this = $(this);

        if (!index) {
          $this.addClass('is-showing').addClass('show-on-load');
        } else {
          $this.addClass('is-hiding').addClass('hide-on-load');
        }
      });

      _helpers.$document.ready(function (e) {
        var t = 250,
            n = 2500,
            r = n - 3e3;
        ...
        setTimeout(function () {
          ...
          i.each(function () {
            var i = e(this),
                s = i.find('.is-showing').outerWidth(),
                c = t - 100;
            setTimeout(function () {
              i.find('p:eq(1)').css('width', s);
            }, c), setTimeout(function () {
              i.find('p:eq(1)').addClass('is-loading');
              ...
              !function e(t) {
                var i = void 0,
                    ...
                    s = o(t),
                    c = o(t).outerWidth();
                t.parents('p').removeClass('is-loading'), a = s, (i = t).hasClass('show-on-load') && i.removeClass('show-on-load'), a.hasClass('hide-on-load') && a.removeClass('hide-on-load'), i.removeClass('is-showing').addClass('is-hiding'), a.removeClass('is-hiding').addClass('is-showing'), setTimeout(function () {
                  e(s);
                }, n), setTimeout(function () {
                  t.parents('p').addClass('is-loading');
                }, r), t.parents('p').css('width', c);
              }(i.find('.is-showing').eq(0));
            }, a);
          });
        }, 2000);
      });
    ...
    value: function initSecondScreen() {
      ...
      this.secondTween.to('' + this.secondScreen, .8, { opacity: 1, ease: _gsap.Power1.easeOut }, .5).fromTo(this.secondScreen + ' h4', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.4).staggerFromTo(this.contetItems, 0.65, {
...
var Services = function () {
  function Services() {
    ...
    this.contetItems = '.service__wrapper  .service__items';
  ...
  _createClass(Services, [{
    ...
    value: function initFirstScreen() {
      ...
      this.firstTween.fromTo('header', .7, { y: -120, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.95).staggerFromTo(this.contetItems, 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
