...
var Common = exports.Common = function () {
  ...
  function Common() {
    ...
    secondtween.fromTo('.first_circle', 2, { y: -75, opacity: 0, ease: _gsap.Power1.easeOut }, {
      y: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    }, .5);

    new _gsap.TimelineMax({}).fromTo('.second_circle', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
      x: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    }, .8);

    new _gsap.TimelineMax({}).fromTo('.third_circle', 2, { x: -45, y: -10, opacity: 0, ease: _gsap.Power1.easeOut }, {
      x: 0,
      y: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    ...
    new _gsap.TimelineMax({}).fromTo('.fourth_circle', 2, { y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
      y: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    }, .5);

    new _gsap.TimelineMax({}).fromTo('.five_circle', 2, { x: 50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
      x: 0,
      y: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    ...
    new _gsap.TimelineMax({}).fromTo('.six_circle', 2, { x: -50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
      x: 0,
      y: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    ...
    new _gsap.TimelineMax({}).fromTo('.seven_circle', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
      x: 0,
      opacity: 1,
      ease: _gsap.Power1.easeOut
    }, .5);

    tween.staggerFromTo('.nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, { opacity: 1, ease: _gsap.Power1.easeOut }, 0.2);
  ...
  _createClass(Common, [{
    ...
    value: function initAnimation() {
      ...
      this.tween.fromTo(['header'], .6, { opacity: 0, y: -70, backgroundColor: 'transparent' }, {
        opacity: 1,
        y: 0,
    ...
    value: function initHeaderAnimation() {
      ...
      _helpers.$window.on('scroll', function (e) {
        ...
        if (!_this.animationInited && st > 200) {
          _this.initAnimation();
          _this.animationInited = true;
        }

        st < lastScrollTop ? _this.tween.play() : _this.tween.reverse();
        lastScrollTop = st;
      });
    }
  }, {
    ...
    value: function initDropdown() {
      $('.dropdown:eq(0) > .menu_link').hover(function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 1, zIndex: 2 });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 0, zIndex: -1 });
      }, function () {});

      $('li:not(.dropdown) > .menu_link').hover(function () {
        console.log('here');
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1 });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 0, zIndex: -1 });
      }, function () {});

      $('.dropdown:eq(1) > .menu_link').hover(function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1 });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 1, zIndex: 2 });
      }, function () {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase__ = __webpack_require__(18);
...
(function(name) {
  ...
  if (typeof(module) !== "undefined" && module.exports) { //node
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(12)], __WEBPACK_AMD_DEFINE_FACTORY__ = (getGlobal),
