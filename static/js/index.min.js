...
var Common = exports.Common = function () {
  ...
  _createClass(Common, [{
    ...
    value: function initContactForm() {
      var $btn = $('.contact_reqeust_btn');

      $btn.click(function (e) {
        e.preventDefault();

        var name = $('.contact__request .name').val();
        var company = $('.contact__request .company').val();
        var email = $('.contact__request .email').val();

        if (name.length <= 2) {
          $('.contact__request .name').parent().addClass(_helpers.css.error);
          return false;
        }

        if (company.length <= 2) {
          $('.contact__request .company').parent().addClass(_helpers.css.error);
          return false;
        }

        if (!Common.validateEmail(email)) {
          $('.contact__request .email').parent().addClass(_helpers.css.error);
          return false;
        }
    ...
    value: function initDropdown() {
      $('.dropdown:eq(0) > .menu_link').hover(function () {
        ...
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
      }, function () {});

      $('li:not(.dropdown) > .menu_link').hover(function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.sub_menu:eq(2)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
      }, function () {});

      $('.dropdown:eq(1) > .menu_link').hover(function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 1, zIndex: 2, visibility: 'visible' });
        _gsap.TweenLite.to($('.sub_menu:eq(2)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
      }, function () {});
      ...
      $('.lang').hover(function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'visible' });
        _gsap.TweenLite.to($('.sub_menu:eq(2)'), .5, { opacity: 1, zIndex: 2, visibility: 'visible' });
      }, function () {});

      $('.sub_menu').hover(function () {}, function () {
        _gsap.TweenLite.to($('.sub_menu:eq(0)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.sub_menu:eq(1)'), .5, { opacity: 0, zIndex: -1, visibility: 'hidden' });
        _gsap.TweenLite.to($('.sub_menu:eq(2)'), .5, { opacity: 1, zIndex: -1, visibility: 'hidden' });
      });
    }
...
var Home = function () {
  ...
  _createClass(Home, [{
    ...
    value: function init() {
      ...
      _helpers.$document.on('click', '.right_button', function () {
    ...
    value: function initFirstScreen() {
      this.firstTween.fromTo('header', .7, { y: -20, opacity: 0 }, {
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .first_circle', 2, { y: -75, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
        ...
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8).fromTo(this.firstScreen + ' .third_circle', 2, { x: -45, y: -10, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1).fromTo(this.firstScreen + ' .fourth_circle', 2, { y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .five_circle', 2, { x: 50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .six_circle', 2, { x: -50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .seven_circle', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.firstScreen + ' .line_arrows', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.firstScreen + ' .btn', .9, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7);
      ...
      new _gsap.TimelineMax({
        repeat: -1
      }).staggerFromTo(this.firstScreen + ' .nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2);
    ...
    value: function initSecondScreen() {
      ...
      this.secondTween.to('' + this.secondScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.secondScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .55).fromTo(this.secondScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8).staggerFromTo(this.contetItems, 0.65, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
    ...
    value: function initThirdScreen() {
      ...
      this.thirdTween.to('' + this.thirdScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.thirdScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .85).fromTo(this.thirdScreen + ' .description', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1.2).staggerFromTo(this.thirdScreenContentItmes, 0.75, {
        opacity: 0,
        y: -20
      }, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power1.easeOut
      }, 0.2, .7).fromTo(this.thirdScreen + ' .line_arrows', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.thirdScreen + ' .btn', .9, { x: 120, opacity: 0 }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .7).fromTo(this.thirdScreen + ' .first_circle', 2, { x: -75, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.thirdScreen + ' .second_circle', 2, { x: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8).fromTo(this.thirdScreen + ' .third_circle', 2, { x: -45, y: -10, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 1).fromTo(this.thirdScreen + ' .fourth_circle', 2, { y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.thirdScreen + ' .five_circle', 2, { x: 50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.thirdScreen + ' .six_circle', 2, { x: -50, y: 45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        x: 0,
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .5).fromTo(this.thirdScreen + ' .item', 2.5, { y: -45, opacity: 0, ease: _gsap.Power1.easeOut }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      ...
      new _gsap.TimelineMax({
        repeat: -1
      }).staggerFromTo(this.thirdScreen + ' .nav0', .3, { opacity: 0, ease: _gsap.Power1.easeOut }, {
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2);
    }
  }, {
    key: 'initFourthScreen',
    value: function initFourthScreen() {
      var _this4 = this;

      if ($('' + this.fourthScreen).hasClass(_helpers.css.finished) || this.fourthTween.isActive()) return;

      this.initThirdScreenParallax();

      this.fourthTween.to('' + this.fourthScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.fourthScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .65).fromTo(this.fourthScreen + ' p', .6, { y: -20, opacity: 0 }, {
        y: 0,
        opacity: 1,
        ease: _gsap.Power1.easeOut
      }, .8).fromTo(this.fourthScreen + ' .item', .6, { scale: 0 }, {
        scale: 1,
        ease: _gsap.Power1.easeOut
      }, 1).fromTo(this.fourthScreen + ' .second_item', .6, { scale: 0 }, {
        scale: 1,
        ease: _gsap.Power1.easeOut
      }, 1.2).staggerFromTo(this.fourthContentItems, .6, { scale: 0, ease: _gsap.Power1.easeOut }, {
        scale: 1,
        ease: _gsap.Power1.easeOut
      }, 0.2, 1.4).addCallback(function () {
        $(_this4.fourthScreen).addClass(_helpers.css.finished);
      });
    ...
    key: 'initFourthScreenParallax',
    value: function initFourthScreenParallax() {
      var $screen = $(this.fourthScreen);
      var $parallaxItems = $screen.find('.parallax');
      var _this = this;
      ...
      $screen.on('mousemove', function (event) {
        ...
        $(_this.fourthContentItems + '}').each(function (index) {
          if (index % 2) {
    ...
    value: function initSliderScreen() {
      ...
      this.sliderTween.to('' + this.sliderScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.sliderScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        ...
        $(_this5.sliderScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initNewsScreen',
    value: function initNewsScreen() {
      ...
      this.newsTween.to('' + this.newsScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.newsScreen + ' h1', .7, { y: -20, opacity: 0 }, {
        ...
        $(_this6.newsScreen).addClass(_helpers.css.finished);
      });
    }
  }, {
    key: 'initCtaScreen',
    value: function initCtaScreen() {
      ...
      this.ctaTween.to('' + this.ctaScreen, .1, { opacity: 1, ease: _gsap.Power1.easeOut }, .3).fromTo(this.ctaScreen + ' h2', .7, { y: -20, opacity: 0 }, {
        ...
        $(_this7.ctaScreen).addClass(_helpers.css.finished);
      });
